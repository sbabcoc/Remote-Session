 ...
 * 
 * <ul>
 *     <li>{@link SessionHolder} - This is a wrapper class for objects that extend the {@link com.jcraft.jsch.Channel
 *         Channel} class. The wrapper implements the {@link java.io.Closeable Closeable} interface, and <b>BatchUtils
 *         </b> uses a "try-with-resources" block to ensure that the channel is always closed regardless of the outcome
 *         of command execution. <b>SessionHolder</b> includes these methods (among others): <ul>
 ...
 *             <li>{@link SessionHolder#assertExitStatus assertExitStatus} - Verifies that the remote task completed normally.</li>
 *         </ul>
 *     </li>
 ...
 *             <li>{@link ChannelStreams#readChannel readChannel} - Read the input from the channel.</li>
 *         </ul>
 *     </li>
 * </ul>
 */
